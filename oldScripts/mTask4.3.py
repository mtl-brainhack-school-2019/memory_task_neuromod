# -*- coding: utf-8 -*-
"""
Created on Sun Sep  1 17:54:38 2019

@author: Francois
"""

#BEST VERSION SO FAR DO NOT MODIFY
import os
import random
import secrets
...
def encoding(trials, nStim, win):
    for trial in trials:
        ...
        for stim in range(len(trial)):
            ...
            core.wait(2.5)
    win.close()
encoding(trials,8,win = visual.Window(size=(1000, 1000), color=(0, 0 , 0), units = 'pix')) 

def recall(trials, nStim, win):
